...
--
-- Host: localhost
-- Generation Time: Jan 09, 2022 at 04:39 PM
...
-- Database: `HR`
--
CREATE DATABASE IF NOT EXISTS `HRTEST` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `HRTEST`;
...
CREATE TABLE `REGIONS` (
  `REGION_ID` int(1) NOT NULL COMMENT 'code of regions',
  `REGION_NAME` varchar(25) DEFAULT NULL COMMENT 'name of region'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `DEPARTMENTS`
  ...
  ADD KEY `FK_DEPARTMENTS_EMPLOYEES` (`MANAGER_ID`),
...
ALTER TABLE `EMPLOYEES`
  ...
  ADD KEY `FK_EMPLOYEES_EMPLOYEES` (`MANAGER_ID`);
...
--
-- Metadata for table JOB_HISTORY
--
...
--
-- Metadata for table REGIONS
--

--
-- Metadata for database HR
--
